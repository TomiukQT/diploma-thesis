...
Kotsiantis\uv{Rozhodovací stromy jsou sekvenční modely, které logicky kombinují posloupnost jednoduchých testů;
každý test porovnává číselný atribut s prahovou hodnotou nebo s nominálním atributem
soubor možných hodnot.} \cite[překlad vlastní]{bibid}s