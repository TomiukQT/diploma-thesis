...
FILL IN ACCORDING TO THE INSTRUCTIONS. VYPLŇTE V SOULADU S POKYNY. TODO
\end{declarationpage}
%%%%%%%%%%%%%%%%%%%
% DECLARATION END
%%%%%%%%%%%%%%%%%%%
...
\include{text/1_intro} % include `text.tex' from `text/' subdirectory

\include{text/2_theory}
